...
.Lpartitioncheck:
	...
	add	t6, t0, a0	# reads array; address of array[boundary]
...
.Ladvancescan:
	...
	j	.Lpartitioncheck	# liveOut t2:pivotValue; liveOut t3:boundary; liveOut t4:scan; The three loop-carried temporaries ride into the next iteration
.Lpartitiondone:
	...
	mv	t5, a0	# reads array; writes array; array -> s0: the first Call clobbers a0
	...
	addi	a2, s2, -1	# reads pivotIndex; left recursion bound: pivotIndex - 1 (a0=array, a1=low are already in place)
	...
	mv	a0, t5	# reads array; first argument again: array
