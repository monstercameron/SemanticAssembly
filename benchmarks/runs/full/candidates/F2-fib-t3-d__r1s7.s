...
fib:
	...
	sd	a0, 0(sp)	# writes firstResult; fib(number-1) -> stack slot before the second Call clobbers a0
	addi	a0, s0, -2	# reads number; argument = number - 2
	call	fib	# a0 = fib(number-2). firstResult survives on the stack — safe; number (s0) is now dead
