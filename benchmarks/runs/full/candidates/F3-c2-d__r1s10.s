...
.Lpartitiondone:
	...
	call	qsort64	# liveOut s0:array; liveOut s1:high; liveOut t0:pivotIndex; qsort64(array, low, pivotIndex-1); three values ride out the call in s0/s1/s2
	mv	t6, s2	# reads pivotIndex; writes pivotIndex; copy pivotIndex into t6 right after the first recursion returns
	mv	a0, s0	# reads array; first argument again: array
	addi	a1, t6, 1	# reads pivotIndex; right recursion bound: pivotIndex + 1, computed from t6
