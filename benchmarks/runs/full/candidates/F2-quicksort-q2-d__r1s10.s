...
.Lpartitiondone:
	...
	mv	s2, a0	# reads array; writes array; array -> s2: the first Call clobbers a0
	mv	s1, a2	# reads high; writes high; high -> s1: needed by the second recursion
	mv	s0, t0	# reads pivotIndex; writes pivotIndex; pivotIndex -> s0: splits the two recursions
	addi	a2, t0, -1	# reads pivotIndex; left recursion bound: pivotIndex - 1 (a0=array, a1=low are already in place)
	call	qsort64	# liveOut s2:array; liveOut s1:high; liveOut s0:pivotIndex; qsort64(array, low, pivotIndex-1); three values ride out the call in s2/s1/s0
	mv	a0, s2	# reads array; first argument again: array
	addi	a1, s0, 1	# reads pivotIndex; right recursion bound: pivotIndex + 1
